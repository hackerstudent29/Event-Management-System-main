...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Primary Admin
        forceUpdateUser("admin@eventbooking.com", "ADMIN", "Admin@123");

        // Authorized Scanner User
        forceUpdateUser("ramzendrum@gmail.com", "ADMIN", "Admin@123");

        // Backup Admin (Emergency Access)
        forceUpdateUser("backup_admin@gmail.com", "ADMIN", "Admin@123");

        // Student/User
        forceUpdateUser("cookwithcomali5@gmail.com", "USER", "User@123");
