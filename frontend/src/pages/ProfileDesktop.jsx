                                                        ...
                                                        <div className="flex items-center gap-6">
                                                            <div className="flex flex-col items-end">
                                                                <div className="flex items-center gap-1.5">
                                                                    <div className={cn("w-2 h-2 rounded-full", booking.status === 'CONFIRMED' ? "bg-emerald-500" : "bg-red-500")} />
                                                                    <span className={cn("text-[10px] font-bold uppercase tracking-widest", booking.status === 'CONFIRMED' ? "text-emerald-600" : "text-red-600")}>
                                                                        {booking.status}
                                                                    </span>
                                                                </div>
