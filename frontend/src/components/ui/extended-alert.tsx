...
// ============================================================================
// EXTENDED ALERT HOOK & COMPONENT (Implementation)
// ============================================================================
...
export const useExtendedAlert = () => {
    ...
    const showAlert = useCallback((title, message, type = 'info') => {
        ...
        // NOTE: Auto-dismiss removed for modal pattern
    }, []);
...
export const ExtendedAlert = ({ state }) => {
    if (!state) return null;

    const { type, title, message, onClose, isOpen } = state;
        ...
        <AlertDialog open={isOpen} onOpenChange={(open) => {
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="pt-2 text-[15px]">
                        {message}
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
